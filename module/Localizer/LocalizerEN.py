...
class LocalizerEN(LocalizerZH):
    ...
    app_new_version_apply_failure: str = "Apply update failed … "
    ...
    platform_edit_page_thinking_content: str = "Set model thinking level (OFF/LOW/MEDIUM/HIGH), only works for models that support thinking mode"
